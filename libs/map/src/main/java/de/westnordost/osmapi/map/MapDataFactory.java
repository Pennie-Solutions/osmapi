...
{	
	 ...
	 *  @param timestamp time at which the node was last updated. May be null.
	 *  @return the node */
	 ...
	 * @param timestamp time at which the way was last updated. May be null.
	 * @return the way
	 */
	 ...
	 * @param timestamp time at which the relation was last updated. May be null.
	 * @return the relation */
